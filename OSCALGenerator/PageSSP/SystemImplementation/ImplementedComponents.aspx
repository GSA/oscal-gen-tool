<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImplementedComponents.aspx.cs" Inherits="OSCALGenerator.PageSSP.SystemImplementation.ImplementedComponents" %>
 ...
 <table style="width:100%">
    ...
    <div id="MainDiv"  runat="server" class="container-fluid">
        <div class ="container">
           <div class="row" width:80%" >
                <h2 style="align-content: center"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Implemented Components</h2>
               <div class="col-md-6">
     
    <asp:Panel ID="AddRolePanel" runat="server"  Height="300px" style="background-color : whitesmoke;" Width="520px">
        <br />
        <table>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label6" runat="server" Text="Components"></asp:Label>
                </td>
                <td>
                   
                    <asp:DropDownList ID="ComponentDropDownList" runat="server" Width="310px"></asp:DropDownList>
                </td>
            </tr>  

            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Use "></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="UseTextBox" runat="server" Width="310px"></asp:TextBox>
                </td>
   ...
   <div class="col-md-6">
    ...
    <asp:Panel ID="GridviewPanel" runat="server">
        ...
        <asp:Button ID="EditButton" runat="server" Text="Add/Edit Implemented Components" OnClick="EditButton_Click" />
        &nbsp;&nbsp;
