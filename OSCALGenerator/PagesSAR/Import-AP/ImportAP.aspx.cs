...
namespace OSCALGenerator.PagesSAR.Import_AP
{
    public partial class ImportAP : BasePage
    {
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            var tag = string.Format("<import-ap href>", href);

            var remarks = RoleRemarksTextarea.InnerText;
            var tagRemarks = string.Format("<import-ap href><remarks>");

            InsertElementToDataBase(DOID, SystemID, "href", href.GetType(), tag, "import-ap href", href, 1);

            InsertElementToDataBase(DOID, SystemID, "remarks", remarks.GetType(), tagRemarks, "import-ap href, remarks", remarks, 1);
        ...
        {
            Response.Redirect(@"~/PagesSAR/Metadata/ResponsibleParties.aspx", false);
        }
