<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAP.Master" AutoEventWireup="true" CodeBehind="SAPResponsibleParties.aspx.cs" Inherits="OSCALGenerator.PagesSAP.Metadata.SAPResponsibleParties" %>
...
<asp:Panel ID="AddRolePanel" runat="server"  Height="250px" style="margin-left: 0px;background-color : whitesmoke;" Width="420px">
    ...
    <asp:Panel ID="GridviewPanel" runat="server"  Width="420px">
