<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAR.Master" AutoEventWireup="true" CodeBehind="DocID.aspx.cs" Inherits="OSCALGenerator.PagesSAR.Metadata.DocID" %>
  ...
  <table style="width:100%">
    ...
    <div id="MainDiv"  runat="server" class="container-fluid">
        <div class ="container">
           <div class="row" style="background-color : whitesmoke; width:80%" >
                <h2 style="align-content: center"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Document Identifier</h2>
               <div class="col-md-6">
     
    <asp:Panel ID="AddRevisionPanel" runat="server"  Height="230px" style="background-color : whitesmoke;" Width="465px">
        <br />
        <table>
            <tr>
                <td>
                ...
                <td>                
                    <asp:DropDownList ID="DocIDDropDownList" runat="server" Width="310px" AutoPostBack="True" OnSelectedIndexChanged="DocIDDropDownList_SelectedIndexChanged" ></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="TitleLabel" runat="server" Text="DOC Identification "></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="IDTextBox" runat="server" Width="310px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:DropDownList ID="TypeDropDownList" runat="server" Height="32px" Width="319px">
                        <asp:ListItem Value="doi">DOI</asp:ListItem>
   ...
   <div class="col-md-6">
    ...
    <asp:Panel ID="GridviewPanel" runat="server">
         <h2 style="align-content: center"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Document Identifiers</h2>
        ...
        &nbsp;&nbsp;&nbsp<asp:Button ID="BackButton" runat="server" Text="Back" OnClick="BackButton_Click" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="EditButton" runat="server" Text="Add/Edit Doc Identifier" OnClick="EditButton_Click" />
        &nbsp;&nbsp;
