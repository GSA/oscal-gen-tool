<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAR.Master" AutoEventWireup="true" CodeBehind="Origination.aspx.cs" Inherits="OSCALGenerator.PagesSAR.Assets.Origination" %>
   ...
   <div id="MainDiv"  runat="server" class="container-fluid">
        <div class ="container">
           <div class="row"  width:80%" >
               <div class="col-md-6">
     <asp:Panel ID="AddRolePanel" runat="server"  Height="240px" style="background-color : whitesmoke;" Width="400px">
        <h3> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Origination </h3>
         <br />
        <table>
