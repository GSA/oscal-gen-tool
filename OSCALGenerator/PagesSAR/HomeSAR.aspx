<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAR.Master" AutoEventWireup="true" CodeBehind="HomeSAR.aspx.cs" Inherits="OSCALGenerator.PagesSAR.HomeSAR" %>
    ...
    <td>
     ...
     <asp:Button ID="OpenFileButton" runat="server" Text="Open File" OnClick="OpenFileButton_Click" ForeColor="#33CC33" />
       &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;
             ...
             <td> 
    <asp:Button ID="OSCALButton" runat="server" OnClick="OSCALButton_Click" Text="Render OSCAL SAR" Width="147px" /> 
               &nbsp;&nbsp;&nbsp;     
             </td>
