<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAR.Master" AutoEventWireup="true" CodeBehind="ImplementedComponents.aspx.cs" Inherits="OSCALGenerator.PagesSAR.AssessmentSubject.LocalDefinitions.ImplementedComponents" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <table style="width:100%">
   <tr>
    ...
    <asp:Panel ID="AddRolePanel" runat="server"  Height="280px" style="background-color : whitesmoke;" Width="520px">
        <br />
        <table>
            <tr>
                <td>
