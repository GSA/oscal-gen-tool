<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAR.Master" AutoEventWireup="true" CodeBehind="InventoryItems.aspx.cs" Inherits="OSCALGenerator.PagesSAR.AssessmentSubjects.LocalDefinitions.InventoryItems" %>
 ...
 <table style="width:100%">
   ...
   <div class="col-md-6">
    ...
    <asp:Panel ID="GridviewPanel" runat="server">
        ...
        <asp:Button ID="EditButton" runat="server" Text="Add/Edit Invetory Items " OnClick="EditButton_Click" />
        &nbsp;&nbsp;
