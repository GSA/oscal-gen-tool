<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAR.Master" AutoEventWireup="true" CodeBehind="ExcludeSubject.aspx.cs" Inherits="OSCALGenerator.PagesSAR.AssessmentSubjects.ExcludeSubject" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="MainDiv"  runat="server" class="container-fluid">
        <div class ="container">
           <div class="row" style="background-color : whitesmoke; width:80%" >
                <h2 style="align-content: center"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Exclude Subjects</h2>
               <div class="col-md-6">
   ...
   <div class="col-md-6">
    ...
    <asp:Panel ID="GridviewPanel" runat="server">
        ...
        <asp:Button ID="EditButton" runat="server" Text="Add/Edit Exclude Subject" OnClick="EditButton_Click" />
        &nbsp;&nbsp;
