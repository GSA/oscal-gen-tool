<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAP.Master" AutoEventWireup="true" CodeBehind="SAPHome.aspx.cs" Inherits="OSCALGenerator.PagesSAP.SAPHome" %>
    ...
    <td>
     ...
     <asp:Button ID="OpenFileButton" runat="server" Text="Open File" OnClick="OpenFileButton_Click" ForeColor="#33CC33" />
       &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;
             ...
             <td> 
    <asp:Button ID="OSCALButton" runat="server" OnClick="OSCALButton_Click" Text="Render OSCAL SAP" Width="147px" /> 
               &nbsp;&nbsp;&nbsp;     
             </td>
