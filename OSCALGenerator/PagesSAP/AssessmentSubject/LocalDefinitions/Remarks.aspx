<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAP.Master" AutoEventWireup="true" CodeBehind="Remarks.aspx.cs" Inherits="OSCALGenerator.PagesSAP.AssessmentSubject.LocalDefinitions.Remarks" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <tr>
    ...
    <asp:Panel ID="AddRolePanel" runat="server"  Height="350px" style="background-color : whitesmoke;" Width="526px">
        <br />
           <h2 style="align-content: center"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Local Definitions: Remarks</h2>
