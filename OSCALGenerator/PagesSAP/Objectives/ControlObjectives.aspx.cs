...
namespace OSCALGenerator.PagesSAP.Objectives
{
    public partial class ControlObjectives : BasePage
    {
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            var baseline = RadioButtonList1.SelectedValue;
            ...
            InsertElementToDataBase(DOID, SystemID, "baseline", baseline.GetType(), tagBaseline, "control-objectives baseline", desc, 1);
            ...
            Response.Redirect(@"~/PagesSAP/Objectives/Methods.aspx", false);
