<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAP.Master" AutoEventWireup="true" CodeBehind="Controls.aspx.cs" Inherits="OSCALGenerator.PagesSAP.Objectives.Controls" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <tr>
    ...
    <div id="MainDiv"  runat="server" class="container-fluid">
        <div class ="container">
           <div class="row" >
                <h2 style="align-content: center"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Controls</h2>
               <div class="col-md-6">
    ...
    <asp:Panel ID="AddDescriptionPanel" runat="server"  Height="350px" style="background-color : whitesmoke;" Width="470px">
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" Text=" Included Controls   "></asp:Label>
                </td>
                <td style="width: 331px">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label5" runat="server" Text=" Excluded Controls   "></asp:Label>
                </td>
                <td style="width: 331px">
  ...
  <asp:Panel ID="AddControlPanel" runat="server"  style="margin-left: 0px;background-color : whitesmoke;" Width="300px">
    <table runat="server">
            ...
            <tr>
                ...
                <td style="height: 22px">
                    <asp:DropDownList ID="ControlDropDownList" runat="server" Width="200px"></asp:DropDownList>
                </td>
            </tr>
        </table>
