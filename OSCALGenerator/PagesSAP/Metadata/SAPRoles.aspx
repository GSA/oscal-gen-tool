<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAP.Master" AutoEventWireup="true" CodeBehind="SAPRoles.aspx.cs" Inherits="OSCALGenerator.PagesSAP.Metadata.SAPRoles" %>
 ...
 <table style="width:100%">
    ...
    <div id="MainDiv"  runat="server" class="container-fluid">
        <div class ="container">
           <div class="row" style="background-color : whitesmoke; width:80%" >
                <h2 style="align-content: center"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Roles</h2>
               <div class="col-md-6">
     
    <asp:Panel ID="AddRolePanel" runat="server"  Height="325px" style="background-color : whitesmoke;" Width="420px">
        <br />
        <table>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="ShortNameTextBox" runat="server" Width="312px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
   ...
   <div class="col-md-6">
    ...
    <asp:Panel ID="GridviewPanel" runat="server">
        ...
        &nbsp;&nbsp;&nbsp<asp:Button ID="BackButton" runat="server" Text="Back" OnClick="BackButton_Click" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="EditButton" runat="server" Text="Add/Edit Role" OnClick="EditButton_Click" />
        &nbsp;&nbsp;
