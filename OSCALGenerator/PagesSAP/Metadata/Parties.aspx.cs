...
namespace OSCALGenerator.PagesSAP.Metadata
{
    public partial class Parties : BasePage
    {
        ...
        {
            Response.Redirect(@"~/PagesSAP/Metadata/LocationsSAP.aspx");
        }

        protected void ContinueButton_Click(object sender, EventArgs e)
        {
            Response.Redirect(@"~/PagesSAP/Metadata/ResponsibleParties.aspx");
        }
        ...
        {
            var list = GetAllHeaders("party id, party id", UserName, DOID);
