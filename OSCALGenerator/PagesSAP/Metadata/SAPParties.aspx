<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSAP.Master" AutoEventWireup="true" CodeBehind="SAPParties.aspx.cs" Inherits="OSCALGenerator.PagesSAP.Metadata.SAPParties" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <table style="width:100%">
   <tr>
    ...
    <asp:Panel ID="AddPropPanel" runat="server"  Height="224px" style="margin-left: 10px;background-color : whitesmoke;" Width="320px">
       ...
       <asp:Panel ID="AddAddressPanel" runat="server" Width="450px" Height="260px"  style="margin-left: 10px;background-color : whitesmoke;">
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <asp:Button ID="RemoveAddressButton" runat="server" Text="Remove" />
       </asp:Panel>
