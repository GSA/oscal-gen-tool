...
{
    public partial class SAPRoles : BasePage
    {
        ...
        {
            var nbrRole = SavedRoles.Count();
            var id = string.Format("role-{0}", nbrRole);
            return id;
        }
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            InsertElementToDataBase(DOID, SystemID, "short-name", roleid.GetType(), tagShortName, "role id, short-name", roleShortName, 1);

            InsertElementToDataBase(DOID, SystemID, "remarks", roleid.GetType(), tagRemarks, "role id, remarks", remarks, 1);
        ...
        {
            Response.Redirect(@"~/PagesSAP/Metadata/RevisionHistory.aspx", false);
        }

        protected void ContinueButton_Click(object sender, EventArgs e)
        {
            Response.Redirect(@"~/PagesSAP/Metadata/Locations.aspx", false);
        }
        ...
        protected void AddEditButton_Click(object sender, EventArgs e)
        {
            ...
            if(PropLabel.Text=="Property")
            {
                ...
                InsertElementToDataBase(DOID, SystemID, propid, propid.GetType(), tagpropid, "role id, prop id", propid, 1);
                InsertElementToDataBase(DOID, SystemID, "name", propid.GetType(), tagname, "role id, prop name", name, 1);

                InsertElementToDataBase(DOID, SystemID, "ns", propid.GetType(), tagns, "role id, prop ns", ns, 1);

                InsertElementToDataBase(DOID, SystemID, "class", propid.GetType(), tagClass, "role id, prop class", classn, 1);
                InsertElementToDataBase(DOID, SystemID, "value", propid.GetType(), tagValue, "role id, prop", value, 1);
            ...
            if (PropLabel.Text == "Annotation")
            {
                ...
                InsertElementToDataBase(DOID, SystemID, annotationId, annotationId.GetType(), tagAnnotationid, "role id, annotation id", annotationId, 1);
                InsertElementToDataBase(DOID, SystemID, "name", annotationId.GetType(), tagname, "role id, annotation name", name, 1);

                InsertElementToDataBase(DOID, SystemID, "ns", annotationId.GetType(), tagns, "role id, annotation ns", ns, 1);

                InsertElementToDataBase(DOID, SystemID, "class", annotationId.GetType(), tagClass, "role id, annotation class", classn, 1);
                InsertElementToDataBase(DOID, SystemID, "value", annotationId.GetType(), tagValue, "role id, annotation", value, 1);

                InsertElementToDataBase(DOID, SystemID, "remarks", annotationId.GetType(), tagRemarks, "role id, annotation, remarks", remarks, 1);
            ...
            if (PropLabel.Text == "Link")
            {
                ...
                var taghref = string.Format("<metadata><role id=\"{0}\"><link href=\"{1}\">", roleid, linkHref);

                var rel = NSTextBox.Text;
                var tagrel = string.Format("<metadata><role id=\"{0}\"><link href=\"{1}\" rel>", roleid, linkHref);

                var media = ClassTextBox.Text;
                var tagmedia = string.Format("<metadata><role id=\"{0}\"><link href=\"{1}\" media-type>", roleid, linkHref);


                var value = ValueTextBox.Text;
                var tagValue = string.Format("<metadata><role id=\"{0}\"><link href=\"{1}\">", roleid, linkHref);

                InsertElementToDataBase(DOID, SystemID, "link", linkHref.GetType(), taghref, "role id, link href", linkHref, 1);
                InsertElementToDataBase(DOID, SystemID, "rel", rel.GetType(), tagrel, "role id, link rel", rel, 1);

                InsertElementToDataBase(DOID, SystemID, "media-type", media.GetType(), tagmedia, "role id, link media-type", media, 1);              
                InsertElementToDataBase(DOID, SystemID, "value", value.GetType(), tagValue, "role id, link", value, 1);
