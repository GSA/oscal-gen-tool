<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="OSCALGenerator.Pages.Home" %>
 ...
 <div runat="server" id="DocDiv"  visible="false" align="center">
  ...
  <table style="border-width: medium; border-color: #C0C0C0; border-style: groove;">
        ...
        <tr>
         ...
         <br />
     <asp:Button ID="StartButton" runat="server" Text="Start " OnClick="StartButton_Click" Width="150px" style="height: 26px" />
    ...
    <br />
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="OSCALButton" runat="server" OnClick="OSCALButton_Click" Text="Render OSCAL SSP" Width="147px" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="WordDocButton" runat="server" Text="Render Word Doc" Width="147px" OnClick="WordDocButton_Click" Visible="False" />
